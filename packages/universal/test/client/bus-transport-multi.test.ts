...
import type { ConnectorHandshake, MessageStamp, IpcBusPeer } from '../../src';
...
describe('ipc-bus-transport-multi', () => {
    ...
    it('should not throw error when posting messages when not connected', () => {
        expect(() => transport.postMessage(transportClient, {} as IpcBusPeer, 'channel', [])).to.not.throw();
    });
